...
from src.data_model.place.place_subclasses import PlaceInfo, RegularOpeningHours, Location, PlaceRating
...
places = Places([
    ...
    Place(
        ...
        regularOpeningHours=RegularOpeningHours(periods=[
            {'open': {'day': 0, 'hour': 1, 'minute': 0}, 'close': {'day': 0, 'hour': 10, 'minute': 0}},
        ]),
    ...
    Place(
        ...
        regularOpeningHours=RegularOpeningHours(periods=[
            {'open': {'day': 1, 'hour': 1, 'minute': 0}, 'close': {'day': 0, 'hour': 10, 'minute': 0}},
        ]),
    ...
    Place(
        ...
        regularOpeningHours=RegularOpeningHours(periods=[
            {'open': {'day': 2, 'hour': 1, 'minute': 0}, 'close': {'day': 0, 'hour': 10, 'minute': 0}},
            {'open': {'day': 6, 'hour': 1, 'minute': 0}, 'close': {'day': 0, 'hour': 10, 'minute': 0}},
        ]),
...
def test_split_basic():
    ...
    assert all(place in [places.get_place_by_id("4"), places.get_place_by_id("5")] for place in splitted[0].get_list())
    assert all(place in [places.get_place_by_id("1"), places.get_place_by_id("2")] for place in splitted[1].get_list())
    assert all(place in [places.get_place_by_id("1"), places.get_place_by_id("3")] for place in splitted[2].get_list())
    assert all(place in [places.get_place_by_id("1"), places.get_place_by_id("4")] for place in splitted[3].get_list())
