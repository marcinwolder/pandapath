...
class TestPlaces(unittest.TestCase):
    ...
    def test_get_time(self):
        ...
        with (patch('src.travel_time.travel_time.TravelEstimator.get_estimated_time') as
              mock_get_estimated_time):
            mock_get_estimated_time.return_value = 60
            places = self.places
            time, arrival_times = places.get_time()

            assert time == 480
            assert arrival_times == {'place1': 60, 'place2': 180, 'place3': 300, 'place4': 420}
