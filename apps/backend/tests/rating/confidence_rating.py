...
place1 = Place(
	...
	ratings=PlaceRating(rating=4.5, userRatingCount=100, confidenceRating=4.0),
)
...
def test_confidence_rating():
	ret = confidence_rating_by_population(
		place1.ratings.rating, place1.ratings.userRatingCount, 1000
	)
...
def test_confidence_rating_2():
	...
	ret = confidence_rating_by_population(
		place1.ratings.rating, place1.ratings.userRatingCount, 100
	)
	print(ret, place1.ratings.rating)
	assert ret < place1.ratings.rating
