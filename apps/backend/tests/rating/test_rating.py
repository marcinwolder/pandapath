...
def data():
	...
	place1 = Place(
		placeInfo={'id': '1'},
		dining={'servesVegetarianFood': True},
		alcohol={'servesBeer': True},
		children={'isFamilyFriendly': True},
		ratings=PlaceRating({'normalizedRating': 4.6}),
		types=['museum', 'park'],
...
def test_categories_only_1():
	user_needs = UserPreferences({}, ['museum', 'park', 'zoo', 'church'], [])
...
def test_no_place_categories():
	user_needs = UserPreferences({}, ['museum', 'park'], [])
...
def test_categories_vs_subcategories():
	...
	place2 = Place(
		placeInfo={'id': '2'},
		subcategories=['Art', 'History', 'Science', 'War', 'Maritime'],
	)
	rating1 = _calculate_cumulative_rating(place1, user_preferences_rating)
	rating2 = _calculate_cumulative_rating(place2, user_preferences_rating)
	assert rating1 == rating2
...
def test_categories_7():
	...
	place1 = Place(
		...
		alcohol=Alcohol(servesBeer=True),
	)
	place2 = Place(placeInfo={'id': '2'}, types=['museum', 'park', 'zoo', 'church'])
	rating1 = _calculate_cumulative_rating(place1, user_preferences_rating)
	rating2 = _calculate_cumulative_rating(place2, user_preferences_rating)
