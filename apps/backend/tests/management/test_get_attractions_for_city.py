...
class TestGetAttractionsForCity(unittest.TestCase):
    ...
    def test_valid_city_and_categories(self, mock_db, mock_place_visitor, mock_nearby_search):
        
        mock_nearby_search.return_value.json.return_value = {'place': [{'name': 'Attraction1', 'category': 'Museum'}]}
