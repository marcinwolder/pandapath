...
categories_keywords_single['default_categories']['museum'] = [
	'art',
	'history',
	'artifacts',
]
categories_keywords_single['categories_nlp']['art_gallery'] = [
	'paintings',
	'exhibitions',
	'art',
	'sculptures',
]
categories_keywords_single['dining']['performing_arts_theater'] = [
	'plays',
	'musicals',
	'performances',
	'opera',
