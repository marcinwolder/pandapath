...
from src.data_model.custom_decorators import dict_behavior
...
class Review:
	...
	originalText: dict[str, str] = field(default_factory=dict)
	publishTime: str = ''
...
class PlaceRating:
	...
	def __post_init__(self):
		if self.confidenceRating <= 0:
			self.confidenceRating = confidence_rating_by_population(
				self.rating, self.userRatingCount
			)
