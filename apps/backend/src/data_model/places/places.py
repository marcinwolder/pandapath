...
class Places:
    ...
    def get_location_dict_with_id(self, place_id: str) -> dict:
        ...
        return {"id": place.placeInfo.id, "lat": place.location.latitude, "lng": place.location.longitude}
    ...
    def sort_by_rating(self):
        ...
        """
        self._places = OrderedDict(sorted(self._places.items(),
                                          key=lambda x: x[1].ratings.cumulative_rating, reverse=True))
        return self
