...
from src.data_model.place.place_subclasses import PlaceInfo, Location, RegularOpeningHours, TimePoint, Period
...
class TripInfo:
    ...
    def __init__(self, user_id="", location=None,
                 user_preferences=None, city=City(), days=1, dates: [date, date]=None):
    ...
    def _init_hotel(self):
        return Place(placeInfo=PlaceInfo(displayName="Hotel", id="0"),
                     location=Location(
                         latitude=self.city.lat, longitude=self.city.lng),
