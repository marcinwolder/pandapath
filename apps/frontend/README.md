...
This package hosts the Angular 16 client that powers CITA System. You can now run it as a traditional browser SPA or bundle it into desktop apps with Electron.
