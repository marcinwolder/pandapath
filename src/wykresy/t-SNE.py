...
words3 = ['restaurant', 'cafe', 'bar', 'coffee', 'lunch', 'dinner', 'breakfast', 'brunch']
words4 = ['restaurant', 'cafe', 'bar', 'coffee', 'beer', 'wine', 'whiskey', 'vodka', 'tea', 'lunch', 'dinner',
          'breakfast', 'brunch']
...
def plot_2(word_vectors_2d, available_words: list, idx: int):
    ...
    for i, word in enumerate(available_words):
        ...
        plt.text(word_vectors_2d[i][0] + 10, word_vectors_2d[i][1] + 5, word, fontsize=12)
