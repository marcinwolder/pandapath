exclude_categories = [
    ...
    "farm",  
    "preschool", "primary_school", "school", "secondary_school",  
    "accounting", "atm", "bank",  
    ...
    "consultant", "courier_service",
    "electrician", "florist", "funeral_home", "hair_care", "hair_salon",
    "insurance_agency", "laundry",
    "lawyer", "locksmith", "moving_company", "painter", "plumber",
    "real_estate_agency", "roofing_contractor",
    "storage", "tailor", "telecommunications_service_provider",
    "travel_agency", "veterinary_care",  
    "ferry_terminal", "heliport", "park_and_ride"  
]
